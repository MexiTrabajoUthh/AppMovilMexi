...
public class MiVacOffActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mi_vac_off);

        txtVacante=(TextView)findViewById(R.id.txMiVacante);
        txtV1_1=(TextView)findViewById(R.id.txMiV1_1);
        txtV2=(TextView)findViewById(R.id.txMiV2);
        txtV2_1=(TextView)findViewById(R.id.txMiV2_1);
        txtV3=(TextView)findViewById(R.id.txMiV3);
        txtV3_1=(TextView)findViewById(R.id.txMiV3_1);
        txtV4=(TextView)findViewById(R.id.txMiV4);
        txtV4_1=(TextView)findViewById(R.id.txMiV4_1);
        ...
        StringRequest respuesta = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if(!response.equals("null")){
                    ...
                    Toast.makeText(MiVacOffActivity.this, "Fallo al procesar", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    void notificar(){
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.O){
            ...
            String description = "Activar Vacante";
        ...
        mBuilder.setSmallIcon(android.R.drawable.stat_notify_chat)
                ...
                .setContentText("Se ha Reactivado tu vacante Exitosamente");
